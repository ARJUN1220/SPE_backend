...
import com.spe.workwise.service.admin.AdminService;
...
class WorkwiseApplicationTests extends AbstractTest{
    ...
    void  registerUserAndDeleteUserTest() throws Exception
    {
        ...
        long userId = super.mapFromJson(content,User.class).getUserId();
